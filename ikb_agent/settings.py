...
class Settings:
    ...
    mineru_source: str = os.getenv("MINERU_SOURCE", "local")
    mineru_formula: bool = _bool_env("MINERU_FORMULA", False)
    mineru_table: bool = _bool_env("MINERU_TABLE", True)
    mineru_image_analysis: bool = _bool_env("MINERU_IMAGE_ANALYSIS", True)
    mineru_extra_args: str = os.getenv("MINERU_EXTRA_ARGS", "")
